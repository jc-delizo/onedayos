...
export const productListQuerySchema = createTableQuerySchema(
  ['code', 'name', 'updatedAt'],
  { categoryId: optionalText(128), isActive: queryBoolean.optional() },
)
export const productCategoryListQuerySchema = createTableQuerySchema(['name', 'updatedAt'], {})
